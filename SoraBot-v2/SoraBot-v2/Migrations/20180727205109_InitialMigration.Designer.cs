...
namespace SoraBotv2.Migrations
{
    ...
    [Migration("20180727205109_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoraBot_v2.Data.Entities.SubEntities.UserWaifu", b =>
                {
                    ...
                    b.Property<ulong>("WaifuForeignId");

                    b.HasKey("Id");

                    b.HasIndex("WaifuForeignId");
            ...
            modelBuilder.Entity("SoraBot_v2.Data.Entities.SubEntities.UserWaifu", b =>
                {
                    b.HasOne("SoraBot_v2.Data.Entities.SubEntities.Waifu", "Waifu")
                        .WithMany()
                        .HasForeignKey("WaifuForeignId")
                        .OnDelete(DeleteBehavior.Cascade);
