...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoraBot.Data.Models.SoraDb.Clan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoraBot.Data.Models.SoraDb.ClanInvite", b =>
                {
            ...
            modelBuilder.Entity("SoraBot.Data.Models.SoraDb.ClanMember", b =>
                {
                    b.Property<ulong>("UserId")
                        .HasColumnType("bigint unsigned");
            ...
            modelBuilder.Entity("SoraBot.Data.Models.SoraDb.Marriage", b =>
                {
            ...
            modelBuilder.Entity("SoraBot.Data.Models.SoraDb.Clan", b =>
                {
                    b.HasOne("SoraBot.Data.Models.SoraDb.User", "Owner")
                        .WithOne("ClanOwner")
                        .HasForeignKey("SoraBot.Data.Models.SoraDb.Clan", "OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SoraBot.Data.Models.SoraDb.ClanInvite", b =>
                {
                    b.HasOne("SoraBot.Data.Models.SoraDb.Clan", "Clan")
                        .WithMany("Invites")
            ...
            modelBuilder.Entity("SoraBot.Data.Models.SoraDb.ClanMember", b =>
                {
                    ...
                    b.HasOne("SoraBot.Data.Models.SoraDb.User", "User")
                        .WithOne("ClanMember")
                        .HasForeignKey("SoraBot.Data.Models.SoraDb.ClanMember", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
